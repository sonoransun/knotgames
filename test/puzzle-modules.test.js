...
// Display position is decoupled from file name (see app.js puzzleRegistry comment).
// `id` is the position the puzzle appears in the sidebar / hash route.
const puzzleFiles = [
  { id: 1,  path: '../puzzles/puzzle-01.js' },
  { id: 2,  path: '../puzzles/puzzle-02.js' },
  { id: 3,  path: '../puzzles/puzzle-03.js' },
  { id: 4,  path: '../puzzles/puzzle-04.js' },
  { id: 5,  path: '../puzzles/puzzle-11.js' }, // Mirror Gate moved to position 5
  { id: 6,  path: '../puzzles/puzzle-05.js' },
  { id: 7,  path: '../puzzles/puzzle-06.js' },
  { id: 8,  path: '../puzzles/puzzle-07.js' },
  { id: 9,  path: '../puzzles/puzzle-16.js' }, // Crossing Number moved to position 9
  { id: 10, path: '../puzzles/puzzle-08.js' },
  { id: 11, path: '../puzzles/puzzle-09.js' },
  { id: 12, path: '../puzzles/puzzle-10.js' },
  { id: 13, path: '../puzzles/puzzle-12.js' },
  { id: 14, path: '../puzzles/puzzle-13.js' },
