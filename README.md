...
The order below is the recommended **learning sequence**. Markdown filenames preserve the original creation IDs and don't always match the position number — see the [reorder note](#a-note-on-puzzle-ordering) below.
...
| 5 | [The Mirror Gate](puzzles/11-the-mirror-gate.md) | Intermediate | Chirality (handedness) | Identification |
| 6 | [Trinity Lock](puzzles/05-trinity-lock.md) | Intermediate | Borromean rings | Assembly |
| 7 | [Devil's Pitchfork](puzzles/06-devils-pitchfork.md) | Intermediate-Advanced | Fundamental group of config space | Transfer |
| 8 | [The Ferryman's Knot](puzzles/07-the-ferrymans-knot.md) | Advanced | Open knot vs closed knot | Disentanglement |
| 9 | [The Crossing Number](puzzles/16-the-crossing-number.md) | Beginner-Intermediate | Unknotting number | Transformation |
| 10 | [Ouroboros Chain](puzzles/08-ouroboros-chain.md) | Advanced | Gray code / binary recursion | Sequential disentanglement |
| 11 | [Genus Trap](puzzles/09-genus-trap.md) | Expert | Genus-2 fundamental group | Disentanglement |
| 12 | [The Hopf Paradox](puzzles/10-the-hopf-paradox.md) | Expert | Hopf fibration | Extraction |
| 13 | [The Braid Cage](puzzles/12-the-braid-cage.md) | Intermediate-Advanced | Braid groups (Yang-Baxter) | Transfer |
| 14 | [The Torus Winder](puzzles/13-the-torus-winder.md) | Advanced | Torus knots — (p,q) winding | Assembly |
...
The series was reordered after pedagogical review. Two puzzles were moved to fix the difficulty curve and concept dependencies:
...
2. **Shepherd's Yoke:** Invert your model of which object moves through which
3. **Prisoner's Ring:** Crossings have signs and can cancel algebraically — count before untangling
4. **Mobius Snare:** Twists change boundary structure — one-sidedness enables escape
5. **Mirror Gate:** Two configurations can look identical yet be topologically distinct — chirality is an invariant your eyes miss
...
11. **Genus Trap:** Invisible topology requires mental models — cord paths encode words in a fundamental group, freed by algebraic cancellation
12. **Hopf Paradox:** Some motions cannot be decomposed into sequential steps — coupled rotation lives in a higher-dimensional space

**Arc 4 — "Classification and Construction" (Puzzles 13-17)**
13. **Braid Cage:** Non-commutative algebra constrains physical operations — the order of swaps matters
14. **Torus Winder:** Knots come in parametric families — (p,q) winding numbers determine knottedness
...
- **Genus** and why holes are topological handles (Puzzles 2, 11)
- **Orientability** and the Mobius boundary (Puzzle 4)
- **Chirality** and mirror-image inequivalence (Puzzle 5)
- **Borromean links** and irreducibly collective properties (Puzzle 6)
- **Configuration spaces** and their non-trivial topology (Puzzle 7)
- **Knot theory** — Reidemeister moves, open arcs vs. closed knots (Puzzles 1, 3, 8)
- **Unknotting number** and crossing changes (Puzzle 9)
- **Gray codes** and recursive complexity (Puzzle 10)
- **Fundamental groups** and algebraic cancellation (Puzzle 11)
- **Fiber bundles** and the Hopf fibration (Puzzle 12)
- **Braid groups** and the Yang-Baxter relation (Puzzle 13)
- **Torus knots** and (p,q) winding number classification (Puzzle 14)
...
| 6 | Trinity Lock | Intermediate | 30-90 min | 5-10 min | Borromean rings |
| 7 | Devil's Pitchfork | Intermediate-Advanced | 1-3 hrs | 10-20 min | Configuration space |
| 8 | The Ferryman's Knot | Advanced | 1-4 hrs | 5-15 min | Open vs. closed knots |
| 9 | The Crossing Number | Beginner-Intermediate | 15-45 min | 5-20 min | Unknotting number |
| 10 | Ouroboros Chain | Advanced | 2-5 hrs | 30-60 min | Gray code recursion |
| 11 | Genus Trap | Expert | 3-8 hrs | 30-90 min | Fundamental group |
| 12 | The Hopf Paradox | Expert | 4-12 hrs | 1-3 hrs | Hopf fibration |
| 13 | The Braid Cage | Intermediate-Advanced | 30-90 min | 15-40 min | Braid groups |
| 14 | The Torus Winder | Advanced | 45-120 min | 20-50 min | Torus knots |
